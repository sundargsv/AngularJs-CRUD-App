                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.country.contryName" id="cname" class="username form-control input-sm" placeholder="Enter country name" required ng-minlength="3"/>
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="c in ctrl.countries">
                              ...
                              <td><span ng-bind="c.contryName"></span></td>
